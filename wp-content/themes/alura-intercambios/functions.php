<?php
    ...
    function alura_intercambios_registrando_taxionomia() {
        register_taxonomy(
            'paises',
            'destinos',
            array(
    ...
    add_action('init', 'alura_intercambios_registrando_taxionomia');
    ...
    function alura_intercambios_registrando_metabox() {
        add_meta_box(
            'alura_intercambios_registrando_metabox',
            'Texto para a home',
            'alura_intercambios_funcao_callback',
            'banners'
        );
    }
    ...
    function alura_intercambios_funcao_callback($post) {
